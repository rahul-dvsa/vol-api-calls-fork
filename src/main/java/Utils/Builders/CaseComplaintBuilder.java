...
public class CaseComplaintBuilder {
    ...
    public String toString() {
        return new ToStringBuilder(ToStringStyle.JSON_STYLE)
                ...
                .append("complainantForename", getComplainantForename())
                .append("complainantFamilyName", getComplainantFamilyName())
                .append("complaintType", getComplaintType())
                .append("status", getStatus())
                .append("isCompliance", getIsCompliance())
                .append("complaintDate", getComplaintDate())
                .append("infringementDate", getInfringementDate())
                .append("description", getDescription())
                .append("vrm", getVrm())
                .append("driverForename", getDriverForename())
                .append("driverFamilyName", getDriverFamilyName()).toString();
    }
}