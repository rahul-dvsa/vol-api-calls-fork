...
public class CreateApplication extends BaseAPI {
    ...
    public String[] getVehicleVRMs() {
        return vehicleVRMs;
    }

    public void setVehicleVRMs(String[] vehicleVRMs) {
    ...
    public int getNoOfTrailersRequested() {
        return noOfTrailersRequested;
    }

    public void setNoOfTrailersRequested(int noOfTrailersRequested) {
        this.noOfTrailersRequested = noOfTrailersRequested;
    }
    ...
    public Boolean getGenerateVRM() {
        return generateVRM;
    }

    public void setGenerateVRM(Boolean generateVRM) {
        this.generateVRM = generateVRM;
    }
    ...
    public ValidatableResponse addVehicleDetails() {
        ...
        generateVRM = generateVRM == null || generateVRM;
        // TODO: Might need to add 'make' to the API builder because DVLA pulls this as well
        // Optional boolean for setting the value to generate VRMs
        if (generateVRM) {
