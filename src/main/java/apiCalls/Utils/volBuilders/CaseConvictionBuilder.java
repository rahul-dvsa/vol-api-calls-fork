...
public class CaseConvictionBuilder {
    ...
    public String toString() {
        return new ToStringBuilder(ToStringStyle.JSON_STYLE)
                ...
                .append("defendantType", getDefendantType())
                .append("personFirstname", getPersonFirstname())
                .append("personLastname", getPersonLastname())
                .append("birthDate", getBirthDate())
                .append("convictionCategory", getConvictionCategory())
                .append("categoryText", getCategoryText())
                .append("offenceDate", getOffenceDate())
                .append("convictionDate", getConvictionDate())
                .append("msi", getMsi())
                .append("court", getCourt())
                .append("penalty", getPenalty())
                .append("costs", getCosts())
                .append("notes", getNotes())
                .append("takenIntoConsideration", getTakenIntoConsideration())
                .append("isDeclared", getIsDeclared())
                .append("isDealtWith", getIsDealtWith())
